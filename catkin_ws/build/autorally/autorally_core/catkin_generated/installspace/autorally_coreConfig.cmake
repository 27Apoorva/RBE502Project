...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'autorally_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/apoorva/catkin_ws/install/${idir}'.  Ask the maintainer 'Brian Goldfain <bgoldfain3@gatech.edu>' to fix it.")
    endif()
