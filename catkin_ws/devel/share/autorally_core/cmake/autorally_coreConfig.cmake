...
if("TRUE" STREQUAL "TRUE")
  set(autorally_core_SOURCE_PREFIX /home/apoorva/catkin_ws/src/autorally/autorally_core)
  set(autorally_core_DEVEL_PREFIX /home/apoorva/catkin_ws/devel)
  ...
  set(autorally_core_INSTALL_PREFIX /home/apoorva/catkin_ws/install)
...
if(NOT "/home/apoorva/catkin_ws/devel/include;/home/apoorva/catkin_ws/src/autorally/autorally_core/include " STREQUAL " ")
  set(autorally_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/apoorva/catkin_ws/devel/include;/home/apoorva/catkin_ws/src/autorally/autorally_core/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'autorally_core' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Brian Goldfain <bgoldfain3@gatech.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'autorally_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/apoorva/catkin_ws/src/autorally/autorally_core/${idir}'.  Ask the maintainer 'Brian Goldfain <bgoldfain3@gatech.edu>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${autorally_core_dep}_FOUND)
      find_package(${autorally_core_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${autorally_core_dep} REQUIRED ${depend_list})
  endif()
